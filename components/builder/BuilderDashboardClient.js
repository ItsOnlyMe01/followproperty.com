  ...
  if (!initialBuilder) {
    return (
      <div className="min-h-screen bg-brand-bg flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-brand-bg-card rounded-3xl border border-brand-border shadow-brand p-8 text-center space-y-6">
          <div className="w-16 h-16 rounded-2xl bg-brand-red-bg text-brand-red flex items-center justify-center mx-auto border border-brand-red-border">
            <ShieldAlert size={32} />
          </div>
          ...
          <div className="bg-brand-bg-alt rounded-xl p-4 text-[11px] text-brand-slate font-medium text-left border border-brand-border">
          ...
          <button
            ...
            className="w-full text-xs font-semibold text-white bg-brand-blue hover:bg-brand-blue-dark border-none cursor-pointer py-2.5 px-4 rounded-lg flex items-center justify-center gap-1.5 transition-all shadow-brand-blue"
          >
